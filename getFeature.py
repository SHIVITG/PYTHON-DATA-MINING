...
def windowCharacter(x):
    ...
    data_dm = scale(tmp,with_mean=True, with_std=False) 
...
for file in glob.glob('C:\\Users\\17303011\\Documents\\DATA\\output\\*-activity.csv'):
    ...
    fName = 'C:\\Users\\17303011\\Documents\\DATA\\features\\' + sub + '-features.csv'
